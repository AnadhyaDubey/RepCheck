...
from services.fitness.calorie_calculator import calculate_calories
...
def main():
    ...
    with st.sidebar:
        st.title("🏋️‍♂️ RepCheck-AI Real-time Gym Coach")
        ...
        if workout_started:
            ...
            st.metric("Calories Burned", f"{round(st.session_state.get('calories_burned', 0), 1)} kcal")
